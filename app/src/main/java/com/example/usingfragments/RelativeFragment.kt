...
class RelativeFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view: View = inflater.inflate(R.layout.fragment_relative,container,false)
...
//        requireView().findViewById<EditText>(R.id.username_editText1).setText(person.name)
//        requireView().findViewById<EditText>(R.id.email_editText1).setText(person.email)
//        requireView().findViewById<EditText>(R.id.password_editText1).setText(person.password)
//        requireView().findViewById<EditText>(R.id.phone_editText1).setText(person.phone)
